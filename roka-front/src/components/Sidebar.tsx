...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-50 flex h-screen w-64 flex-col overflow-y-auto border-r border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-900">
          ...
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) => cn(
                ...
                isActive
                  ? "border border-slate-200 bg-white font-semibold text-amber-600 shadow-sm dark:border-slate-700 dark:bg-slate-800"
                  : "text-slate-500 hover:bg-slate-200/70 hover:text-slate-900 dark:text-slate-100 dark:hover:bg-slate-800 dark:hover:text-white"
              )}
            >
              {({ isActive }) => (
                <>
      ...
      <div className="border-t border-slate-200 bg-slate-200/30 p-4 dark:border-slate-700 dark:bg-slate-900/40">
